package kr.anima.xd.s.own.main;
...
import kr.anima.xd.s.own.db.DBOpener;
import kr.anima.xd.s.own.db.DBStructure;
...
public class PurposeActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opener=new DBOpener(this); // DB OPEN
...
//            data.put(PurposeEntry.COLUMN_OBJECTIVE, title);
...
//        }
    ...
    public void insertData(){
        // Insert type
        // purpose, objective, schedule, task, tracker

        purposeValues.put(UserEntry.COLUMN_PURPOSE, title);
//        purposeValues.put(COL_DESCRIPTION, description);
        purposeValues.put(UserEntry.COLUMN_TIMESTAMP, dtStart);
//        purposeValues.put(UserEntry.COLUMN_FINAL_TIMESTAMP, dtEnd);
